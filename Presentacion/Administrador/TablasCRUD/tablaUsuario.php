...
<body>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'] . DIRECTORIO_RAIZ . RUTA_COMPONENTES . 'sidebarUsuario.php'; ?>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody class="list">
                                    ...
                                    $numeroTotalDeFilas = $manejoUsuario->cantidadUsuario();
                                    ...
                                    if ($numeroTotalDeFilas > 0) {
                                        ...
                                        if ($totalPaginas > 1) {
                                            if ($pagina != 1) {
                                                echo '<li class="page-item disabled"><a class="page-link" href="tablaUsuario.php?pagina=' . ($pagina - 1) . '"><i class="fas fa-angle-left"></i></a></li>';
                                            }
                                            ...
                                            for ($i = 1; $i <= $totalPaginas; $i++) {
                                                if ($pagina == $i) {
                                                    ...
                                                    echo '<li class="page-item"><a class="page-link" href="tablaUsuario.php?pagina=' . $i . '">' . $i . '</a></li>';
                                                }
                                            }
                                            ...
                                            if ($pagina != $totalPaginas) {
                                                ...
                                                echo '<li class="page-item"><a class="page-link" href="tablaUsuario.php?pagina=' . ($pagina + 1) . '"><i class="fas fa-angle-right"></i></a></li>';
                                            }
                                        }
                                        echo '</ul>';
                                        echo '</nav>';
