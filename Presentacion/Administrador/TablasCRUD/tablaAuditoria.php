...
include_once($_SERVER['DOCUMENT_ROOT'] . DIRECTORIO_RAIZ . RUTA_MANEJOS . "ManejoAuditoria.php");
...
$manejoAuditoria = new ManejoAuditoria($conexionActual);
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody class="list">
                                    ...
                                    $numeroTotalDeFilas = $manejoAuditoria->cantidadAuditoria();
                                    ...
                                    if ($numeroTotalDeFilas > 0) {
                                        ...
                                        foreach ($listadoAuditoria as $auditoria) {

                                            $numero = $numero + 1;

                                            echo "<tr>";
                                            echo "<td>" . $numero . "</td>";
                                            echo "<td>" . $auditoria->getNombreTabla() . "</td>";
                                            echo "<td>" . $auditoria->getDireccionIP() . "</td>";
                                            echo "<td>" . $auditoria->getOperacionRealizada() . "</td>";
                                            echo "<td>" . $auditoria->getViejoValor() . "</td>";
                                        ...
                                        if ($totalPaginas > 1) {
                                            if ($pagina != 1) {
                                                echo '<li class="page-item disabled"><a class="page-link" href="tablaAuditoria.php?pagina=' . ($pagina - 1) . '"><i class="fas fa-angle-left"></i></a></li>';
                                            }
                                            ...
                                            for ($i = 1; $i <= $totalPaginas; $i++) {
                                                if ($pagina == $i) {
                                                    ...
                                                    echo '<li class="page-item"><a class="page-link" href="tablaAuditoria.php?pagina=' . $i . '">' . $i . '</a></li>';
                                                }
                                            }
                                            ...
                                            if ($pagina != $totalPaginas) {
                                                ...
                                                echo '<li class="page-item"><a class="page-link" href="tablaAuditoria.php?pagina=' . ($pagina + 1) . '"><i class="fas fa-angle-right"></i></a></li>';
                                            }
                                        }
                                        echo '</ul>';
                                        echo '</nav>';
